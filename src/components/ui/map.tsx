...
export function WorldMap({
    ...
    return (
        <div className="w-full aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1] bg-[var(--bg)] rounded-lg relative font-sans overflow-hidden">
            <Image
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center justify-center h-full">
                                                <span className={`${labelClassName} font-medium px-1.5 py-0.5 rounded bg-[var(--bg)]/95 text-[var(--text-primary)] border border-[var(--border)] shadow-sm whitespace-nowrap`}>
                                                    {dot.start.label}
                                                </span>
                                            </div>
                                        </foreignObject>
            ...
            <AnimatePresence>
                {hoveredLocation && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 10 }}
                        className="absolute bottom-4 left-4 bg-[var(--bg)]/90 text-[var(--text-primary)] px-3 py-2 rounded-lg text-sm font-medium backdrop-blur-sm sm:hidden border border-[var(--border)]"
                    >
                        {hoveredLocation}
                    </motion.div>
                )}
